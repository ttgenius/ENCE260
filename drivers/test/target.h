...
/* LED matrix columns.  */
#define LEDMAT_COL1_PIO PIO_DEFINE(PORT_C, 5)
#define LEDMAT_COL2_PIO PIO_DEFINE(PORT_C, 7)
#define LEDMAT_COL3_PIO PIO_DEFINE(PORT_C, 4)
#define LEDMAT_COL4_PIO PIO_DEFINE(PORT_B, 7)
#define LEDMAT_COL5_PIO PIO_DEFINE(PORT_C, 6)
...
#define IR_TX_HIGH_PIO PIO_DEFINE(PORT_D, 3)
#define IR_TX_LOW_PIO PIO_DEFINE(PORT_D, 0)
